...
{
	/* Macro from debug.h, targeting the output to USART6 or to semihosting
	according to debugUSE_DEBUG_UART and debugUSE_DEBUG_SEMIHOSTING values */
	debugPUTCHAR(c);
}
