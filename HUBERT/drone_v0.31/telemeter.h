...
enum telemeterId
{
	...
	TLM_FRT = 0x01,		/** Front telemeter identifier */
	TLM_LFT_FRT = 0x02,	/** Left front telemeter identifier */
	TLM_LFT_BCK = 0X04,	/** Left back telemeter identifier */
	TLM_RGT_FRT = 0x08,	/** Right front telemeter identifier */
	TLM_RGT_BCK = 0x10,	/** Right back telemeter identifier */
	TLM_BCK = 0x20,		/** Back telemeter identifier */
	TLM_BOT	= 0x40		/** Bottom telemeter identifier */
};
