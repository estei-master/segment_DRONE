...
{
volatile uint16_t ADCConvertedValues[8];
...
inline uint16_t usTelemeterGetDist( const enum telemeterId eTelemeterId )
{
	...
	case TLM_FRT:
		/*PA5*/
		return (ADCConvertedValues[0]*5);
	case TLM_BCK:
		/*PA6*/
		return (ADCConvertedValues[1]*5);
	case TLM_RGT_FRT:
		/*PA7*/
		return (ADCConvertedValues[2]*5);
	case TLM_RGT_BCK:
		/*PC4*/
		return (ADCConvertedValues[3]*5);
	case TLM_LFT_FRT:
		/*PC5*/
		return (ADCConvertedValues[4]*5);
	case TLM_LFT_BCK:
		/*PB0*/
		return (ADCConvertedValues[5]*5);
	case TLM_BOT:
		/*PC3*/
		return (ADCConvertedValues[6]*5);
